...
public class CartVO {
   ...
   public CartVO setP_id(int p_id) {
      this.p_id = p_id;
      return this;
   }
   ...
   public String toString() {
      return "CartVO [u_id=" + u_id + ", p_id=" + p_id + ", amount=" + amount + ", p_name=" + p_name + ", p_price="
            + p_price + ", p_content=" + p_content + ", cart_id=" + cart_id + ", cnt=" + cnt + "]";
   }
