...
public class DBConnectionPool {
	...
	final int PRE_POOL_SIZE =5; //미리 생성할 크기
	String url;
	String username;
	String password;
	...
	public DBConnectionPool(String driver,String url, String username, String password, int poolSize) throws Exception{
		this.url= url;
	...
	public Connection getConnection() throws SQLException {
		...
		if(connList.size() > 0 ) {
			 ...
			 *  그러므로 아래는 conn객체가 DB와 연결되어있는지 확인 하는 것*/
			if(conn.isValid(10))
				return conn;
